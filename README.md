...
Built with pure HTML + CSS + minimal vanilla JS. No frameworks, no build step — deploys directly to Netlify via this repository.

**Live site:** https://saeid-amini.netlify.app
